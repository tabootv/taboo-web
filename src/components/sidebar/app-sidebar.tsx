...
import { ChevronUp, User2, Settings, CreditCard, LogOut } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
            ...
            <SidebarMenuItem>
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/profile/edit-password" className="flex items-center gap-2">
                      <Settings className="size-4" />
                      <span>Settings</span>
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={handleLogout} className="text-red-primary focus:text-red-primary">
