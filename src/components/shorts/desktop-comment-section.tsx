...
export function DesktopCommentSection({ video }: DesktopCommentSectionProps) {
  ...
  return (
    <div className="hidden md:inline absolute !z-[1000] w-full max-w-[525px] h-full max-h-[858px] bg-[#2a2727] right-0 bottom-0 top-[6.5rem] rounded-l-[30px] overflow-hidden">
      {/* Sticky header */}
      <div className="w-full sticky z-50 top-0 bg-[#2a2727]">
        {/* Header bar */}
...
function SingleComment({ comment }: { comment: any }) {
  return (
