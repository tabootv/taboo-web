      ...
      <div className="flex flex-col md:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-4 mb-8">
            <h1 className="text-3xl font-bold tracking-tight text-white">Subscription</h1>
            {pollingAfterManage && (
              <span
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm mt-1">
                    Your subscription has been canceled. You may still have access until the end of
                    your billing period.
                  </p>
                  <Link
                    href="/choose-plan"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-text-secondary text-base mb-8 max-w-md mx-auto">
                  Get unlimited access to exclusive creator content, early releases, and HD
